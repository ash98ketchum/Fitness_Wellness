...
export default function ExpertReport() {
  ...
  const handleDownloadPDF = () => {
    ...
    doc.text('Athelya Clinical Nutrition Report', 14, 20);
    ...
    for (let i = 1; i <= pageCount; i++) {
      ...
      doc.text(
        `Generated by Athelya Agent Ecosystem | Page ${i} of ${pageCount}`,
        14,
        doc.internal.pageSize.height - 10
      );
    }

    doc.save(`Athelya_Report_${user?.name?.replace(/\s+/g, '_')}.pdf`);
